import { createClient, Session, User, AuthResponse } from '@supabase/supabase-js';
...
export const signOut = (): Promise<{ error: Error | null }> => {
...
export const onAuthStateChange = (callback: (session: Session | null) => void): { unsubscribe: () => void } => {
