...
const TaskList: React.FC<TaskListProps> = ({ tasks, projects, setTasks, setProjects }) => {
  ...
  const handleAddTask = (e: React.FormEvent): void => {
    ...
    if (!projectId && projects.length > 0 && projects[0]) projectId = projects[0].id;
                     ...
                     >
                         ...
                         <div className="flex-1 min-w-0">
                             ...
                             <div className="flex items-center gap-3 text-xs text-gray-400 mt-0.5">
                                 ...
                                 {task.deadline && (
                                     <span className={`flex items-center gap-1 ${task.deadline < new Date().toISOString().substring(0, 10) ? 'text-red-400' : ''}`}>
                                         <Calendar size={10} />
